...
<!-- This file is a scaffold template seeded by `claw-forge init`. It is identical to
     the claw-forge project's own .claude/commands/import-spec.md and is copied here so
     that projects initialized with claw-forge have the command available immediately. -->
